...
CREATE OR REPLACE PROCEDURE LOGISTICS_DW_PROD.PERFORMANCE.GENERATE_COST_OPTIMIZATION_RECOMMENDATIONS()
RETURNS STRING
LANGUAGE SQL
AS
$$
...
AS
BEGIN
    CALL LOGISTICS_DW_PROD.PERFORMANCE.GENERATE_COST_OPTIMIZATION_RECOMMENDATIONS();
END;

-- Create cost optimization alerts
CREATE OR REPLACE PROCEDURE LOGISTICS_DW_PROD.PERFORMANCE.CHECK_COST_OPTIMIZATION_ALERTS()
RETURNS STRING
LANGUAGE SQL
AS
$$
