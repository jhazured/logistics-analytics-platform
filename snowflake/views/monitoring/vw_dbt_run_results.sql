...
WITH model_execution_simulation AS (
    SELECT 
        'tbl_ml_haul_segmentation' AS model_name,
    ...
    SELECT 
        'tbl_ml_customer_behavior_segments' AS model_name,
        'analytics.ml_features' AS schema_name,
        'table' AS materialization,
        'success' AS status,
    ...
    SELECT 
        'tbl_ml_consolidated_feature_store' AS model_name,
        'analytics.ml_features' AS schema_name,
        'table' AS materialization,
        'success' AS status,
    ...
    SELECT 
        'tbl_ml_rolling_analytics' AS model_name,
    ...
    SELECT 
        'vw_consolidated_dashboard' AS model_name,
