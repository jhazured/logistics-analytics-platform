...
CREATE OR REPLACE TABLE LOGISTICS_DW_PROD.OPTIMIZATION.PREDICTIVE_COST_OPTIMIZATION (
...
CREATE OR REPLACE VIEW LOGISTICS_DW_PROD.OPTIMIZATION.VW_PREDICTIVE_COST_ANALYSIS AS
WITH cost_trends AS (
    SELECT 
        warehouse_name,
        DATE_TRUNC('day', start_time) as cost_date,
...
CREATE OR REPLACE PROCEDURE LOGISTICS_DW_PROD.OPTIMIZATION.GENERATE_COST_OPTIMIZATION_RECOMMENDATIONS()
RETURNS STRING
LANGUAGE SQL
AS
$$
...
BEGIN
    ...
    DELETE FROM LOGISTICS_DW_PROD.OPTIMIZATION.PREDICTIVE_COST_OPTIMIZATION
    WHERE optimization_date = CURRENT_DATE();
    
    -- Insert new recommendations
    INSERT INTO LOGISTICS_DW_PROD.OPTIMIZATION.PREDICTIVE_COST_OPTIMIZATION (
    ...
    SELECT 
        ...
        business_impact
    FROM LOGISTICS_DW_PROD.OPTIMIZATION.VW_PREDICTIVE_COST_ANALYSIS
    ...
    FROM LOGISTICS_DW_PROD.OPTIMIZATION.PREDICTIVE_COST_OPTIMIZATION
    WHERE optimization_date = CURRENT_DATE();
...
CREATE OR REPLACE VIEW LOGISTICS_DW_PROD.OPTIMIZATION.VW_COST_OPTIMIZATION_DASHBOARD AS
...
CREATE OR REPLACE TASK LOGISTICS_DW_PROD.OPTIMIZATION.TASK_COST_OPTIMIZATION_ANALYSIS
...
AS
BEGIN
    CALL LOGISTICS_DW_PROD.OPTIMIZATION.GENERATE_COST_OPTIMIZATION_RECOMMENDATIONS();
END;

-- Create cost optimization alerts
CREATE OR REPLACE PROCEDURE LOGISTICS_DW_PROD.OPTIMIZATION.CHECK_COST_OPTIMIZATION_ALERTS()
RETURNS STRING
LANGUAGE SQL
AS
$$
...
ALTER TASK LOGISTICS_DW_PROD.OPTIMIZATION.TASK_COST_OPTIMIZATION_ANALYSIS RESUME;
