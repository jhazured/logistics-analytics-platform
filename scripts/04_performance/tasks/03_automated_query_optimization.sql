...
CREATE OR REPLACE PROCEDURE LOGISTICS_DW_PROD.PERFORMANCE.SP_generate_query_optimization_recommendations()
RETURNS STRING
LANGUAGE SQL
AS
$$
...
AS
BEGIN
    CALL LOGISTICS_DW_PROD.PERFORMANCE.SP_generate_query_optimization_recommendations();
END;

-- Create query optimization alerts
CREATE OR REPLACE PROCEDURE LOGISTICS_DW_PROD.PERFORMANCE.SP_check_query_optimization_alerts()
RETURNS STRING
LANGUAGE SQL
AS
$$
