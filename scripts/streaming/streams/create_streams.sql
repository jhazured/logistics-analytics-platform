...
ON TABLE LOGISTICS_DW_PROD.MARTS.TBL_FACT_SHIPMENTS
...
ON TABLE LOGISTICS_DW_PROD.MARTS.TBL_FACT_VEHICLE_TELEMETRY
...
ON TABLE LOGISTICS_DW_PROD.MARTS.TBL_FACT_ROUTE_PERFORMANCE
...
CREATE OR REPLACE STREAM LOGISTICS_DW_PROD.STAGING.TBL_STG_SHIPMENTS_STREAM 
ON TABLE LOGISTICS_DW_PROD.STAGING.TBL_STG_SHIPMENTS
COMMENT = 'Stream for staging shipment data changes';

CREATE OR REPLACE STREAM LOGISTICS_DW_PROD.STAGING.TBL_STG_VEHICLE_TELEMETRY_STREAM 
ON TABLE LOGISTICS_DW_PROD.STAGING.TBL_STG_VEHICLE_TELEMETRY
...
ON TABLE LOGISTICS_DW_PROD.MARTS.TBL_DIM_CUSTOMER
